...
public interface PersonRepositoryInterface {
  ...
  */
  ...
  HashMap<String, List<Person>> groupPeopleByJob();
  ...
  */
  ...
  HashMap<String, Double> averageJobSalary(); 
  //Ứng với mỗi nghề nghiệp (job - String), tính mức lương trung bình (Double)
  HashMap<String, Double> top5HighestSalaryCities(); 
  //Tìm 5 thành phố có mức lương trung bình cao nhất, sắp xếp từ cao xuống thấp

  HashMap<String, Double> averageJobAge(); 
  //Ứng với mỗi loại job hãy tính độ tuổi trung bình

  HashMap<String, Double> averageCityAge(); 
